        ...
        <>
            <section className="mx-auto max-w-6xl px-8 pb-24 pt-20">
                <div className="mb-16 border-b border-line pb-16">
                    <h1 className="text-[clamp(2.4rem,6vw,4.2rem)] lowercase">
                    ...
                    <div className="mt-6 flex gap-8 font-utility">
                        <p className="text-sm tracking-wide text-text-dim">NOV 15-17, 2026</p>
                        <p className="text-sm tracking-wide text-text-dim">PIER 70, SF</p>
                    </div>
                </div>
